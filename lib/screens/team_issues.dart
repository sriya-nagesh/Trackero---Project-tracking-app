...
class TeamIssues extends StatefulWidget {
  const TeamIssues({Key? key, required this.docID}) : super(key: key);
  final String docID;
  @override
  State<TeamIssues> createState() => _TeamIssuesState();
}

class _TeamIssuesState extends State<TeamIssues> {
...
//update issue
  Future<void> update([DocumentSnapshot? documentSnapshot]) async {
    if (documentSnapshot != null) {
      issueName = documentSnapshot['teamIssueName'];
      issueDescription = documentSnapshot['teamIssueDescription'];
    }
    await showDialog(
      context: context,
                  ...
                  if (updateIssueNameTextfield.text.isNotEmpty &&
                    ...
                    try {
                      ...
                      await teamproject
                          ...
                          .collection("issues")
                          .doc(documentSnapshot.id)
                          .update({"teamIssueDescription": description});
...
//delete issue
  ...
  Widget build(BuildContext context) {
    final issuesRefresh = teamproject
        .doc(widget.docID)
        .collection("issues")
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              if (issueNameTextfield.text == '' &&
                                ...
                                await AddTeamIssues().createTeamIssuesModel(
