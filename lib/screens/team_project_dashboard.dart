...
class TeamDashboard extends StatefulWidget {
  const TeamDashboard({Key? key, required this.docID}) : super(key: key);
  final String docID;
...
//update goal
  Future<void> update([DocumentSnapshot? documentSnapshot]) async {
    if (documentSnapshot != null) {
      teamgoalname = documentSnapshot['teamGoalName'];
    }
    await showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Container(
            ...
            child: TextField(
              controller: updategoal..text = teamgoalname,
...
//get mission, vision, project name and pm from project database

  projectM() async {
    final ref = teamproject.doc(widget.docID).withConverter(
          fromFirestore: TeamProjectModel.fromFirestore,
          toFirestore: (TeamProjectModel teamProjectModel, _) =>
              teamProjectModel.toFirestore(),
        );
    final docSnap = await ref.get();
    final teamProjectModel = docSnap.data();
    if (teamProjectModel != null) {
      return teamProjectModel.ownerEmail;
    } else {}
  }
  ...
  Future getName() async {
    ...
    final teamProjectModel = docSnap.data();
    if (teamProjectModel != null) {
      return teamProjectModel.teamProjName;
    } else {}
  }
  ...
  Future getMission() async {
    ...
    final teamProjectModel = docSnap.data();
    if (teamProjectModel != null) {
      return teamProjectModel.mission;
    } else {}
  }
  ...
  Future getVision() async {
    ...
    final teamProjectModel = docSnap.data();
    if (teamProjectModel != null) {
      return teamProjectModel.vision;
    } else {}
  }
  ...
  String projectname = "", projectmission = "", projectvision = "", email = "";
  ...
  Widget build(BuildContext context) {
    ...
    final goalsRefresh = teamproject
        .doc(widget.docID)
        .collection('goals')
        .where('projectID', isEqualTo: widget.docID);
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: IconButton(
                                      ...
                                      icon: const Icon(CommunityMaterialIcons
